...
Upon completion of the program, the student will have at least a B1 level command of the Russian language."
    ...
    "The program is implemented in the bachelor's degree format and is designed for 4 years of study, or 240 credits. The student's starting level should be at least A2. The program's profile is aimed at training a Russian language teacher for a foreign-speaking audience. Students will study theoretical linguistics courses, a practical Russian language course, and methods of teaching it in a foreign language classroom. The training takes place in conditions of maximum immersion in the language environment, and provides live communication with native speakers of the Russian language. At the initial stage of training, English can be used for mediation purposes. The graduate of the program will be proficient in Russian at the C1 level." =>
        "Программа реализуется в формате бакалавриата и рассчитана на 4 года обучения, или 240 кредитов. Исходный уровень студента должен быть не ниже A2. Профиль программы направлен на подготовку преподавателя русского языка для иностранноязычной аудитории. Студенты будут изучать курсы теоретической лингвистики, практический курс русского языка и методику его преподавания в классе иностранного языка. Обучение проходит в условиях максимального погружения в языковую среду и обеспечивает живое общение с носителями русского языка. На начальном этапе обучения для целей медиативного общения может использоваться английский язык. Выпускник программы будет владеть русским языком на уровне C1.",
    'Vacancies' => 'Вакансии',
    'We invite talented specialists to join our team!' => 'Мы приглашаем талантливых специалистов присоединиться к нашей команде!',
    'Contacts for applications' => 'Контакты для откликов',
    'If you want to apply for a vacancy, use a convenient way to contact us' => 'Если вы хотите откликнуться на вакансию — используйте удобный для вас способ связи',
    '28 University Street, Main Building, Room 228' => 'Улица Университетская, 28, главный корпус, каб. №228',
    'Apply now' => 'Откликнуться',
     'Computer Science Teacher' => 'Преподаватель информатики',
    'A teacher is required for the specialty "Computer Science". Work experience of at least 2 years.' => 'Требуется преподаватель по специальности "Информатика". Опыт работы от 2 лет.',
    'Higher education' => 'Высшее образование',
    'Teaching experience' => 'Опыт преподавания',
    'Knowledge of modern IT technologies' => 'Знание современных IT-технологий',

    'Accountant' => 'Бухгалтер',
    'We are looking for a responsible accountant to manage financial reporting.' => 'Ищем ответственного бухгалтера для ведения финансовой отчетности.',
    'Higher economic education' => 'Высшее экономическое образование',
    'Knowledge of 1C' => 'Знание 1С',
    'Work experience of at least 3 years' => 'Опыт работы от 3 лет',

    'Student Affairs Manager' => 'Менеджер по работе со студентами',
    'A manager is required to organize the educational process and interact with students.' => 'Требуется менеджер для организации учебного процесса и взаимодействия со студентами.',
    'Communication skills' => 'Коммуникабельность',
    'Responsibility' => 'Ответственность',
    'Ability to work with documents' => 'Умение работать с документами',

    'System Administrator' => 'Системный администратор',
    'A system administrator is required to support the university\'s IT infrastructure.' => 'Требуется системный администратор для поддержки IT-инфраструктуры университета.',
    'Work experience in IT for at least 2 years' => 'Опыт работы в IT от 2 лет',
    'Knowledge of network technologies' => 'Знание сетевых технологий',
