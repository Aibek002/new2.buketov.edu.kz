    ...
    public function init()
{
    $this->css = [
        ...
        'css/article.css?v=' . filemtime(Yii::getAlias('@webroot/css/article.css')),
        'css/staff-management-structure.css?v=' . filemtime(Yii::getAlias('@webroot/css/staff-management-structure.css')),
