...
function openGeneralRulesPdfMagistr(filePath, type) {
    let selector = '.general-rules-pdf-magistr'; // Это класс
    const general_rules_pdf = document.querySelector(selector); // получаем элемент по классу
...
function openGeneralRulesPdfDoctoral(filePath, type) {
    let selector = '.general-rules-pdf-doctoral'; // Это класс
    const general_rules_pdf = document.querySelector(selector); // получаем элемент по классу
