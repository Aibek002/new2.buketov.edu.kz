            ...
            <div class="navbar navbar-expand-md fixed-top  p-3 header">
                <a class="navbar-brand" href="<?= Yii::$app->homeUrl ?>">
                    <?= Html::img('/bg-images/logo-buketov.png', [
                        ...
                        'style' => 'max-height: 60px;' // Установите нужную высоту
                    ]) ?>
                </a>
                        ...
                        <div class="dropdown-menu-header">
                            ...
                            <div class="d-flex g-2 my-5 dropdown-main-flex">
                                ...
                                <div class="dropdown-menu-social">
                                    ...
                                    <div class="social">
                                        <a target="_blank" href="https://t.me/buketov_university"><svg width="39"
                                        ...
                                        <a target="_blank" href="https://www.instagram.com/buketov.university?igsh=MThseGUwY3NjN2dtZA=="><svg width="39" height="39" viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                        ...
                                        <a target="_blank" href="https://www.tiktok.com/@buketov.university?_t=ZM-8zPpJTHd0ZJ&_r=1"><svg width="37" height="37" viewBox="0 0 37 37" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <a target="_blank" href="https://www.facebook.com/share/1BCrtnkGNj/?mibextid=wwXIfr"><svg width="39" height="39" viewBox="0 0 39 39" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                        ...
                                        <a target="_blank" href="https://youtube.com/@karagandastateuniversity?si=HrRoPybxJbg-VG_Y"><svg width="39" height="27" viewBox="0 0 39 27" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
