            ...
            <?php foreach ($pdf as $pdf_item): ?>
                <?php if ($pdf_item['lang_pdf'] === $lang && $pdf_item['skill_level_id'] === 2): ?>
                    ...
                    <?php if ($pdf_item['ref_sort_order_id'] === 1): ?>
                        ...
                        <button
                            onclick='openGeneralRulesPdf("/pdf/admission/magistracy/<?= Yii::$app->language ?>/<?= $pdf_item["path"] ?>")'>
                            <?= $pdf_item["name_url"] ?>
                        </button>
                    <?php endif ?>
                <?php endif ?>
            ...
            <?php foreach ($pdf as $pdf_item): ?>
                <?php if ($pdf_item['lang_pdf'] === $lang && $pdf_item['skill_level_id'] === 3): ?>
                    ...
                    <?php if ($pdf_item['ref_sort_order_id'] === 1): ?>
                        ...
                        <button
                            onclick='openGeneralRulesPdf("/pdf/admission/doctorant/<?= Yii::$app->language ?>/<?= $pdf_item["path"] ?>")'>
                            <?= $pdf_item["name_url"] ?>
                        </button>
                    <?php endif ?>
                <?php endif ?>
