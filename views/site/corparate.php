...
<div class="modal fade" id="staffModal" tabindex="-1" aria-labelledby="staffModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4 p-0 overflow-hidden"
            style="background: #f9f9f9;max-width: 1440px;max-height: 880px;">

            <!-- Header -->
            <div class="modal-header border-0"
                style="background: linear-gradient(145deg, #274b7a, #2f5fa1); color: #fff;">
                <h5 class="modal-title text-white fw-bold" id="staffModalLabel">ФИО</h5>
            ...
            <div class="modal-body d-flex p-4">
                ...
                <div class="ms-4 flex-grow-1" style="max-height: 70vh;height:300px; overflow-y: auto;">
